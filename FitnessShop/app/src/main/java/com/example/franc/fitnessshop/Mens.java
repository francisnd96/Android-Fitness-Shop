...
public class Mens extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fra = new FirebaseRecyclerAdapter<Item, ItemViewHolder>(Item.class,R.layout.item_list,ItemViewHolder.class,ref.orderByChild("Gender").equalTo(catId+"Men")) {
            @Override
